package com.eduard.dogs.dogs.presentation.fragment;
...
import com.eduard.dogs.dogs.presentation.base.BaseFragment;
...
public class DogsListFragment extends BaseFragment implements DogsListContract.View {
    ...
    @Override
    public void setBreedList(Map<String, List<String>> dogsList) {
        //TODO
